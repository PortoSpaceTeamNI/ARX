...
export const useMissionControl = create<MissionControlState>()((set) => ({
  ...
  telemetry: {
    ...
    status: {
      ...
      hydraUf: {
        ventValve: ValveState.Unknown,
        pressurizingValve: ValveState.Unknown,
        probeThermo1: 0,
        probeThermo2: 0,
        probeThermo3: 0,
      },
      hydraLf: {
        mainValve: ValveState.Unknown,
        abortValve: ValveState.Unknown,
        probeThermo1: 0,
        probeThermo2: 0,
      ...
      hydraFs: {
        n2: {
          fillValve: ValveState.Unknown,
          purgeValve: ValveState.Unknown,
          pressure: 0,
        },
        n2o: {
          fillValve: ValveState.Unknown,
        ...
        quickDc: {
          n2Valve: ValveState.Unknown,
          n2oValve: ValveState.Unknown,
          pressure: 0,
        },
      },
      navigator: {
